...
HRB = beepdown.hrb color.hrb hello4.hrb winhello.hrb sosu.hrb cat.hrb iroha.hrb chklang.hrb bball.hrb invader.hrb calc.hrb tview.hrb mmlplay.hrb
BUILD = ./build-cache/
SRC = ./haribote/
APP_SRC = ./app/
...
CC = gcc
CFLAGS=-Wall -c -march=i486 -m32 -fno-pic -fno-stack-protector
