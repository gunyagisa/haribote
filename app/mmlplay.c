...
void HariMain(void) {
  ...
  static int tonetable[12] = {1071618315, 1135340056, 1202850889, 1274376125,
                              1350154473, 1430438836, 1515497155, 1605613306,
                              1701088041, 1802240000, 1909406767, 2022946002};
    ...
    if (('A' <= *p && *p <= 'G') || *p == 'R') {
      ...
      if (i != note_old) {
        ...
        if (28 <= note_old && note_old <= 107) {
          api_boxfillwin(win, (note_old - 28) * 3 + 8, 60,
                         (note_old - 28) * 3 + 10, 76, 7);
        }
        if (28 <= i && i <= 107) {
